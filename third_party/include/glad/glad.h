/*
    ...
    OpenGL loader generated by glad 0.1.36 on Mon Sep  8 19:20:42 2025.
...
// Fix for C++23: ensure size_t and ssize_t are defined before including KHR headers
#ifdef __cplusplus
#include <cstddef>
#include <cstdint>
// ssize_t is POSIX, not standard C++, so we need to include it properly
#if defined(__unix__) || defined(__unix) || defined(__APPLE__) || defined(__linux__)
#include <sys/types.h>
#elif defined(_WIN32)
// Windows doesn't have ssize_t, define it based on pointer size
#ifdef _WIN64
