...
**Purpose**: Interactive element with input and layout
...
- [Based on actual code in `src/ui/UIElement.cpp`]
...
- [API Documentation](../../API/UI/UIElement.md)
