...
if(GIT_FOUND AND EXISTS "${CMAKE_SOURCE_DIR}/.git")
    ...
    if(NOT "${GIT_STATUS_OUTPUT}" STREQUAL "")
        ...
        # 设置变量以便其他部分可以查询状态
        set(GIT_HAS_UNCOMMITTED_CHANGES TRUE CACHE INTERNAL "Git has uncommitted changes")
    else()
        message(STATUS "Git仓库状态：干净 (Git repository: clean)")
        set(GIT_HAS_UNCOMMITTED_CHANGES FALSE CACHE INTERNAL "Git has uncommitted changes")
    endif()
else()
    if(NOT GIT_FOUND)
